...
function getAppData(token) {
  $.ajax({
    type: "GET",
    url: "/xdnd/upload/files/location.json",
  }).done(function (res) {
    try {
      dongia = res
      let strItem = '';
  ...
  $.ajax({
    type: "GET",
    url: "/xdnd/upload/files/thongso-nhapho.json",
  }).done(function (res) {
    try {
      thongso_nhapho = res;
    } catch (error) {
  ...
  $.ajax({
    type: "GET",
    url: "/xdnd/upload/files/thongso-bietthu.json",
  }).done(function (res) {
    try {
      thongso_biethu = res;
    } catch (error) {
  ...
  $.ajax({
    type: "GET",
    url: "/xdnd/upload/files/thongso-cap4.json",
  }).done(function (res) {
    try {
      thongso_cap4 = res;
    } catch (error) {
